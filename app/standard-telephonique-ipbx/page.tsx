...
export default function StandardIPBXPage() {
  return (
    <>
      <BreadcrumbJsonLd items={[{ name: "Accueil", url: "https://www.csx-telecom.fr/" }, { name: "Standard téléphonique IP & IPBX", url: "https://www.csx-telecom.fr/standard-telephonique-ipbx" }]} />
